 ...
 const list = [
   {
     ...
     img: "https://source.unsplash.com/random/800x500/?chat",
     description:
   ...
   {
     title: "SwarnaLehenga",
     img: "https://source.unsplash.com/random/800x500/?saree",
     description:
   ...
   },
   {
     ...
     description:
       "A Note-taking web-app that harmonizes simplicity with functionality using React. ",
     link: "https://keepinator.vercel.app/",
   },
 ];
